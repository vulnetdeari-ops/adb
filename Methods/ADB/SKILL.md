---
name: adb
description: "Ask. Decide. Build. Setup copies this file into each project as ADB.md, and copies factory AGENTS.md as AGENTS.md. Activates only when METHOD.md says METHOD: ADB — not when missing or PLAIN. Talk, proof, secrets, git, roles: the project’s AGENTS.md."
---
